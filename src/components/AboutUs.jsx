export default function AboutUs() {
  return (
    <section id="about" className="scroll-mt-20 bg-emerald-50 dark:bg-gray-900 py-16 px-6 md:px-12 text-center">
      ...
      <div className="grid sm:grid-cols-3 gap-6 mt-10 max-w-4xl mx-auto text-left">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-5">
          <h3 className="font-semibold text-gray-800 dark:text-gray-100">What We Offer</h3>
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-5">
          <h3 className="font-semibold text-gray-800 dark:text-gray-100">Get Involved</h3>
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
